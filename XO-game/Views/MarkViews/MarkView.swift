...
public class MarkView: UIView, Copying {
    ...
    required init(_ porototype: MarkView) {
        super.init(frame: porototype.frame)
        self.lineColor = porototype.lineColor
        self.lineWidth = porototype.lineWidth
        self.textColor = porototype.textColor
    }
